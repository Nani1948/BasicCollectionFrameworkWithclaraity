...
public class InterfaceCanbeImplementedInTheAbstractClass extends Test5 {
	public static void main(String []args) {
		InterfaceCanbeImplementedInTheAbstractClass t=new InterfaceCanbeImplementedInTheAbstractClass();
		t.add();
		t.add1();
		t.add2();
		t.add3();
